  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Hiba történt a rendszerünkben. Próbáld újra, vagy térj vissza a főoldalra.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BBS Core" },
      { name: "description", content: "Boo Base System vezérlőpult" },
      { name: "author", content: "BBS" },
      { property: "og:title", content: "BBS Core" },
      { property: "og:description", content: "Boo Base System vezérlőpult" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@BBSCore" },
    ],
    links: [
      {
        rel: "stylesheet",
